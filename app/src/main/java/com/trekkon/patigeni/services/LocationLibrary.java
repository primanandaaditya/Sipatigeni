...
public class LocationLibrary {
	...
	private void startService() {
		Intent serviceIntent = new Intent(mContext, PatigeniLocationService.class);
		serviceIntent.putExtra(PatigeniLocationService.BROADCAST_INTERVAL, mInterval);
	...
	public boolean isServiceRunning() {
		...
		for (RunningServiceInfo service : manager
			...
			if (PatigeniLocationService.class.getName().equals(
